...
<section class="main-container">
  ...
  <section class="content">
    ...
    <section class="cards-container">
      <div class="home-card">
        <div class="card-title">
          <h3>Tienda</h3><span class="arrow-right"><a href="catalogo/">&rarr;</a></span>
        </div>
      ...
      <div class="home-card">
        <div class="card-title">
          <h3>Dulce Vida</h3><span class="arrow-right"><a href="restaurante-eventos/">&rarr;</a></span>
        </div>
        <hr class="card-spacer">
      ...
      <div class="home-card">
        <div class="card-title">
          <h3>Vinícola</h3><span class="arrow-right"><a href="nosotros/">&rarr;</a></span>
        </div>
        <hr class="card-spacer">
    ...
    <style>
      ...
      section.single-product section.content section.product-details section.add-cart a {}
    </style>
    <section class="titled-section">
      <h1 class="title">
