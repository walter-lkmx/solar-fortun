    ...
    <section class="single">
      ...
      <div class="content"> 
        ...
        <div class="text">
          ...
          <p>Solar Fortún has two different locations open to the public:</p><p>Our vineyard is located in Francisco Zarco in the northern edge of Valle de Guadalupe where you will find our beautiful property and tasting terrace surrounded by centennial old oak trees. We are open at this location on Fridays, Saturdays and Sundays from noon to 6pm and have a restaurant that is specialized in food that pairs phenomenally with our wines.</p>
          <a href="https://goo.gl/maps/sexpRC2AjBRFnWCL7" target="_blank">See on Google Maps</a>
          <p>Our winemaking facilities are located in el Sauzal, at the entrance to Ensenada right in front of the ocean.  Here we have VIP barrel tastings (reservation only) and starting Autumn 2022 we will have an oceanfront winebar. Plans for a new restaurant at this location are currently being developed.</p>
        </div>
      </div>
    </section>
  </section>
